...
export interface ApiHomeCtaHomeCta extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    CTAButtonText: Schema.Attribute.String & Schema.Attribute.Required;
...
export interface ApiHomeHeroHomeHero extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    partnersLabel: Schema.Attribute.Text & Schema.Attribute.Required;
    partnersLogo: Schema.Attribute.Media<'images', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiHomePrimaryFeatureHomePrimaryFeature
  extends Struct.SingleTypeSchema {
  collectionName: 'home_primary_features';
  info: {
    singularName: 'home-primary-feature';
    pluralName: 'home-primary-features';
    displayName: 'HomePrimaryFeatures';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    features: Schema.Attribute.Component<'home.primary-feature', true> &
      Schema.Attribute.Required;
    title: Schema.Attribute.String & Schema.Attribute.Required;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-primary-feature.home-primary-feature'
    >;
  };
}

export interface ApiHomeSecondaryFeatureHomeSecondaryFeature
  extends Struct.SingleTypeSchema {
  collectionName: 'home_secondary_features';
  info: {
    singularName: 'home-secondary-feature';
    pluralName: 'home-secondary-features';
    displayName: 'HomeSecondaryFeature';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    title: Schema.Attribute.String & Schema.Attribute.Required;
    description: Schema.Attribute.Text & Schema.Attribute.Required;
    features: Schema.Attribute.Component<'home.secondary-feature', true> &
      Schema.Attribute.Required;
    createdAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    publishedAt: Schema.Attribute.DateTime;
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::home-secondary-feature.home-secondary-feature'
    >;
  };
}
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::home-primary-feature.home-primary-feature': ApiHomePrimaryFeatureHomePrimaryFeature;
      'api::home-secondary-feature.home-secondary-feature': ApiHomeSecondaryFeatureHomeSecondaryFeature;
